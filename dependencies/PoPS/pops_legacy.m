...
% @05SEP2025: this wrapper is retired. Instead use pops() wrapper, which
% uses directly munges features from FLAMES pipeline. Only use this for
% mungin new features (almost never the case for gene prioritization)
...
arguments
    ...
    opts.featurewd {mustBeFolder} = fullfile(fileparts(which("pops.m")), "pops_features_full") % downloaded from FLAMES
