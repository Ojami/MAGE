...
% same. But for small matrices I've observed setting K0 to a lower value
% can also be physiologically meaningful (case in point, when K = K0, MARC1
% and GPAM are not selected, but setting K0 < K includes both. Maybe this
% is the result of optimal cut-off approach)
