...
% 
% @08NOV2024: some minor changes were made.
...
chridx = find(ismember(hdr.lower, ["chr", "chromosome", "chrom", "xchr"]), 1);
afreqidx = find(ismember(hdr.lower, ["effect_allele_frequency", "af_allele2", "a1freq", "a1_freq", "maf", "a2freq"]), 1);
...
nidx = find(ismember(hdr.lower, ["samplesize", "n"]), 1);
